...
public class SuperMigLayout extends JPanel{
	...
	public SuperMigLayout(int nb, String t)
	{
		...
		setLayout(new MigLayout("", "[::30,fill][200,grow,fill]", "[][150,grow,fill]"+nbLigne));
	...
	public void setComponent(int laCase, String libelle, Component infoC)
	{
		...
		((JLabel) infoC).setText(textCompo);
	...
	public void setThumbnail()
	{
		...
		File pathThumb = new File(tabThumb[0]);			//prend arbitrairement le premier backdrop
		if (pathThumb.exists())
		{
