...
public class LibraryTree extends JTree {
	...
	private class MyRenderer extends DefaultTreeCellRenderer {
		 ...
		 */
		private static final long serialVersionUID = 1L;
		private Icon mediaIcon = getIcon(getClass().getClassLoader().getResource("org/t3/metamediamanager/gui/icons/Media.png"));
	    private Icon mediaRedIcon = getIcon(getClass().getClassLoader().getResource("org/t3/metamediamanager/gui/icons/MediaRed.png"));
	    private Icon folderIcon = getIcon(getClass().getClassLoader().getResource("org/t3/metamediamanager/gui/icons/Folder.png"));
