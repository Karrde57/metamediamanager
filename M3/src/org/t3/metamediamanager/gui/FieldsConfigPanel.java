...
import org.t3.metamediamanager.FieldsConfig;
...
public class FieldsConfigPanel extends JPanel {
	...
	public FieldsConfigPanel() {
		...
		btnDelete.setIcon(new ImageIcon(FieldsConfig.class.getResource("/org/t3/metamediamanager/gui/icons/Trash.png")));
		...
		btnNewField.setIcon(new ImageIcon(FieldsConfig.class.getResource("/org/t3/metamediamanager/gui/icons/Plus.png")));
